...
import { BadRequestError, OrderStatus, requireAuth, validateRequest } from '@node_ms/common';
...
router.post('/api/orders',requireAuth,[
          ...
          .withMessage('TicketID must be valid and not NULL')
     ...
     // run query to look at all OrderStatus. Find an order where the
     ...
     // sending status code to client side
